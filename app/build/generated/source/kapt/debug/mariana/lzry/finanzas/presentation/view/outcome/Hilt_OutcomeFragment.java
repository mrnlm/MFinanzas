...
public abstract class Hilt_OutcomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OutcomeFragment() {
    super();
  }

  Hilt_OutcomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OutcomeFragment_GeneratedInjector) this.generatedComponent()).injectOutcomeFragment(UnsafeCasts.<OutcomeFragment>unsafeCast(this));
    }
  }
